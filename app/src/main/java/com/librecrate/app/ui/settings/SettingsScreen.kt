        ...
        AlertDialog(
            ...
            confirmButton = {
                Button(onClick = {
                    ...
                    exportLauncher.launch("LibreCrate-$dateStr.librecrate-backup")
                }) {
                    Text("Export")
                }
            },
...
private fun AboutSection(context: Context) {
    ...
    Card(modifier = Modifier.fillMaxWidth()) {
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Text(
                text = "github.com/DavidNeurieder/LibreCrate",
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.primary,
                modifier = Modifier.clickable {
                    val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/DavidNeurieder/LibreCrate"))
